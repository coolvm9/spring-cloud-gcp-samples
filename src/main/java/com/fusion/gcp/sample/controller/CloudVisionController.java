...
package com.fusion.gcp.sample.controller;

import com.fusion.gcp.sample.operations.OcrStatusReporter;
...
public class CloudVisionController {
  ...
  public ModelAndView submitDocument(@RequestParam("documentUrl") String documentUrl)
    ...
    // Run OCR on the document ( Reference to Blob ID of new uploaded docu
